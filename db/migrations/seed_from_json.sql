...
BEGIN
    ...
    VALUES ('環遊世界', 'Faichun - 環遊世界', 'faiachun', 'FC-001', 20.00, 100, true, '{v-rect,square}', NOW())
    ...
    -- Product: 煩事遠離朕 銀紙當被冚
    INSERT INTO products (product_name, product_description, product_type, sku, price, quantity, is_active, available_sizes, created_at)
    VALUES ('煩事遠離朕 銀紙當被冚', 'Faichun - 煩事遠離朕 銀紙當被冚', 'faiachun', 'FC-005', 20.00, 100, true, '{square,big-square}', NOW())
    RETURNING product_id INTO new_id;
    ...
    INSERT INTO product_images (product_id, image_path, thumbnail_path, alt_text, size_type, sort_order, is_primary)
    VALUES (new_id, '/api/media/products/big-square-煩事遠離朕 銀紙當被冚.jpg', '/api/media/products/big-square-煩事遠離朕 銀紙當被冚-sm.jpg', '煩事遠離朕 銀紙當被冚', 'big-square', 1, false);
    ...
    -- Product: 生意興隆 撈乜都掂
    INSERT INTO products (product_name, product_description, product_type, sku, price, quantity, is_active, available_sizes, created_at)
    VALUES ('生意興隆 撈乜都掂', 'Faichun - 生意興隆 撈乜都掂', 'faiachun', 'FC-068', 20.00, 100, true, '{square,big-square}', NOW())
    RETURNING product_id INTO new_id;
    ...
    INSERT INTO product_images (product_id, image_path, thumbnail_path, alt_text, size_type, sort_order, is_primary)
    VALUES (new_id, '/api/media/products/big-square-生意興隆 撈乜都掂.jpg', '/api/media/products/big-square-生意興隆 撈乜都掂-sm.jpg', '生意興隆 撈乜都掂', 'big-square', 1, false);
